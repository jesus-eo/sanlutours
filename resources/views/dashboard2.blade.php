...
<body class="h-screen flex " style="background: #edf2f7;">
    <aside class=" z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
    <div>
        ...
        <ul class="space-y-2 tracking-wide mt-8">
            <li>
                <a href="#" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4 rounded-xl hover:bg-gradient-to-r from-sky-600 to-cyan-400 hover:text-white ">
            ...
            <li>
                <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md hover:bg-gradient-to-r from-sky-600 to-cyan-400 hover:text-white  group">
            ...
            <li>
                <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md hover:bg-gradient-to-r from-sky-600 to-cyan-400 hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div class="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
        <button class="px-4 py-3 flex items-center space-x-4 rounded-md hover:bg-gradient-to-r from-sky-600 to-cyan-400 hover:text-white">
