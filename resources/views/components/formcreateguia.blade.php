            ...
            <form action="{{Route('guias.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4" >
                    ...
                    <div class="mb-4">
                        ...
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus outlinr-none @error('imagen') border-red-500 @enderror" placeholder="imagen" required>
                    </div>
                    <div class="flex items-center justify-evenly w-full">
                       ...
                       class="rounded-md  hover:bg-blue-600 transition duration-300 bg-blue-700  text-white font-bold py-2 px-4 my-3">Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
