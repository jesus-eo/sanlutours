            ...
            <form action="{{Route('tours.store')}}" method="post">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4" >
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="plazas" id="plazas"  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus outlinr-none" placeholder="Plazas" >
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="precio" id="precio"  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus outlinr-none" placeholder="precio" >
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="valoracion" id="valoracion" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus outlinr-none" placeholder="valoracion" >
                    </div>
                    <div class="mb-4">
