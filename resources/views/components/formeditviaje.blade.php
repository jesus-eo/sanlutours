            ...
            <form id="formedittour" action="{{Route('viajes.update',[$viaje])}}" method="post">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4" >
                   ...
                   <div class="mb-4">
                        ...
                        <input type="text" name="fechahora" id="fechahora" value="{{ old('fechahora', $viaje->fechahora) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus outlinr-none" pattern="^[0-9]{4}(-|/)(0[1-9]|1[0-2])(-|/)(0[1-9]|[1-2][0-9]|3[0-1]) (2[0-3]|[01][0-9]):[0-5][0-9]:[0-5][0-9]$" title="YYYY-MM-DD HH:MM:SS" placeholder="YYYY/MM/DD 00:00:00" required >
                    </div>
                   <div class="mb-4">
                        <label for="plazas" class="block text-gray-700 text-sm font-bold mb-2">Plazas</label>
                        <input type="number" name="plazas" id="plazas" value="{{ old('plazas', $viaje->plazas) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus outlinr-none" min="1" required placeholder="Plazas" >
                    </div>
