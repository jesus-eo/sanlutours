            ...
            <form action="{{Route('guias.update',[$guia])}}" method="post" enctype="multipart/form-data">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4" >
                    <div class="mb-4">
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $guia->nombre) }}"  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus outlinr-none" placeholder="Nombre" required>
                    </div>
                    <div class="mb-4">
