        ...
        <div id="container-envolvente-sn">
            <div id="bloque1-pag-principal" role="contentinfo">
                ...
                <div class="sm:hidden" id="mobile-menu" x-show="open" @click.away="open=false">
                    ...
                    <li>
                        <a href="#" class="text-white  block px-3 py-2 rounded-md text-base font-medium" title="Enlace a sección Sobre nosotros">Sobre
                            nosotros</a>
                    </li>
                    <li>
                ...
                <div id="container-central">
                    <div id="container-difuminado">
                         ...
                         <p>Esta iniciativa nace de la pasión por mi ciudad , de la cual deseo que los visitantes de ella conozcan todos sus explendidos rincones, sus estupendos bares  que guardan una gran historia detrás de ellos y gracias a ellos hemos optenido el galardón de capital española de la gastronomía, también invito a conocer los variados paisajes que consta dicha ciudad en los que podremos disfrutar de magnificas puestas de sol donde guardarás un recuerdo inolvidable en definitiva
                             VOLVERAS  </p>
                    </div>
                </div>
            </div>
