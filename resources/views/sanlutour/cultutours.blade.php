<x-clasetour>
    ...
    <div>
        <div class="orden-tour flex">
            ...
            <a class="text-md border-2 rounded-md  text-white hover:bg-green-900 hover:text-white transition duration-300" href="{{Route('cultutours',['fecha'])}}">Fecha</a>
            <a class="text-md border-2 rounded-md  text-white hover:bg-green-900 hover:text-white transition duration-300" href="{{Route('cultutours',['precio'])}}">Precio</a>
        </div>
