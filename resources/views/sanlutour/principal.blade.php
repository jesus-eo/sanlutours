    ...
    <body>
        ...
        <div id="container-envolvente-principal">
            <div id="bloque1-pag-principal" role="contentinfo">
                ...
                <header class="encabezado-b1-principal">
                    <div id="container-logo">
                        <!--  <object id="logo" data="img/Página principal/dibujo2.svg" type="image/svg+xml"
                        title="logo portafolio jesús manuel"></object> -->
                        <picture id="logo">
                ...
                <main role="main" class="main-b1-principal">
                    ...
                    <p class="p2-main-b1">Bienvenidos a SanluTours , conoce los mejores tours por la ciudad de Sanlúcar.</p>
                </main>
            </div>
            ...
            <div id="b3-pagina-principal" role="contentinfo">
                <div id="b3-video">
                    <video id="video-sanlucar" preload controls poster="{{ asset('Img/Página principal/imagen figma video.jpg')}}"
                        title="Video descriptivo sobre sanlúcar de barrameda">
                        <source src="{{ asset('Img/Página principal/video.mp4 ')}}"
                            type="video/mp4">
            ...
            <div id="b4-pagina-principal" role="contentinfo">
                ...
                <div id="b4-imagen">
                    <picture title="Imagen Tours destacado doñana">
                        <img class="img-slider" src="{{ asset('Img/Página principal/Tour destacado doñana.jpg')}}" alt="Imagen Tours destacado doñana">
                    </picture>
                </div>
            </div>
            ...
            <div id="b5-pagina-principal">
                <div id="container-b5">
                    ...
                    <p id="b5-p">Cómo puedo empezar a describir mi tiempo con SanluTours... ¡Simplemente me cambió la vida! Siempre imaginé que Sanlúcar de Barrameda sería un destino impresionante, pero gracias a SanluTours, pude no solo experimentar la cultura,  gastronomía, sino también tener recuerdos únicos en la vida. Obtuve mucho más de lo que esperaba de mis vacaciones.</p>
