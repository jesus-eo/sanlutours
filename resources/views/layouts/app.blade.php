...
<body class="flex">
    ...
    <div class="h-full bg-gray-100 w-full flex" id="container-dashboard" x-data="datos()">
        ...
        <div class="-mr-2 flex items-center md:hidden">
         ...
         <div class="sm:hidden" id="mobile-menu-dashboard" x-show="icono" @click.away="icono=false">
                ...
                @if (Auth::user()->administrador != null)
                        ...
                        <li>
                            <a href="{{ route('crudtours') }}" title="Tours" class="text-white px-4 py-3 flex items-center space-x-4 rounded-md hover:bg-gradient-to-r from-green-600 to-green-400 hover:text-white">
                        ...
                        <li>
                            <a href="{{ route('crudguias') }}" title="Guías" class="text-white px-4 py-3 flex items-center space-x-4 rounded-md hover:bg-gradient-to-r from-green-600 to-green-400 hover:text-white ">
                                <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <li>
                            <a href="{{ route('crudreservas') }}" title="Reservas" class="text-white px-4 py-3 flex items-center space-x-4 rounded-md hover:bg-gradient-to-r from-green-600 to-green-400 hover:text-white  group">
                                <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <li>
                            <a href="{{ route('crudusuarios') }}" title="Usuarios" class="text-white px-4 py-3 flex items-center space-x-4 rounded-md hover:bg-gradient-to-r from-green-600 to-green-400 hover:text-white">
                                <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <form method="POST" action="{{ route('logout') }}" x-data >
                        ...
                        <a class="text-white px-4 py-3 flex items-center space-x-4 rounded-md hover:bg-gradient-to-r from-green-600 to-green-400 hover:text-white  group" href="{{ route('logout') }}" @click.prevent="$root.submit();">
                            <svg class="h-5 w-5">
